// Copyright 2024 The dart-ollama Authors. All rights reserved.
...
void main(List<String> args) async {
  await build(args, (input, output) async {
    ...
    if (prebuiltPath != null) {
      ...
      _addCodeAsset(output, prebuiltPath, targetOS, targetArch);
      return;
    }
    ...
    if (builtPath != null) {
      ...
      _addCodeAsset(output, builtPath, targetOS, targetArch);
    } else {
      throw Exception(
