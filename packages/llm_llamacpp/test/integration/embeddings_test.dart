...
void main() {
  ...
  group('Embeddings', () {
    ...
    test('generates single text embedding', () async {
      if (modelPath == null) {
    ...
    test('embedding dimensions consistency', () async {
      if (modelPath == null) {
        markTestSkipped('No model available');
        return;
      }
    ...
    test('embedding similarity - similar texts', () async {
      if (modelPath == null) {
        markTestSkipped('No model available');
        return;
      }
    ...
    test('embedding consistency - same text', () async {
      if (modelPath == null) {
        markTestSkipped('No model available');
        return;
      }
    ...
    test('handles empty string embedding', () async {
      if (modelPath == null) {
        markTestSkipped('No model available');
        return;
      }
    ...
    test('handles very long text embedding', () async {
      if (modelPath == null) {
        markTestSkipped('No model available');
        return;
      }
    ...
    test('handles special characters in embedding', () async {
      if (modelPath == null) {
        markTestSkipped('No model available');
        return;
      }
