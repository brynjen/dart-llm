...
///
/// Requires API key to be set via ANTHROPIC_API_KEY environment variable.
library;
...
void main() {
  group('Claude Integration Tests - Edge Cases', () {
    ...
    group('Edge Case Tests', () {
      ...
      test(
        'backendOptions max_tokens override',
        () async {
          if (!hasApiKey()) {
            markTestSkipped('API key not available');
            return;
          ...
          // With 50 max_tokens the response should be short
