...
void main() {
  group('Claude Integration Tests - Streaming Behavior', () {
      ...
      test(
        ...
        () async {
          ...
          expect(
            ...
            greaterThan(0),
            reason: 'Should have prompt token count',
          );
          expect(
            done.evalCount,
            greaterThan(0),
            reason: 'Should have output token count',
          );
        },
        tags: ['integration'],
        timeout: const Timeout(Duration(minutes: 2)),
