/// Comprehensive integration test suite for llm_claude against the Anthropic API.
///
/// This test suite verifies that the package can successfully communicate with
/// the Anthropic API using the claude-haiku-4-5-20251001 model for chat.
///
...
/// Run this test:
/// ```bash
/// cd packages/llm_claude
/// ANTHROPIC_API_KEY=your-key dart test test/integration/all_integration_tests.dart
/// ```
///
/// Run all integration tests:
/// ```bash
/// ANTHROPIC_API_KEY=your-key dart test test/integration
/// ```
///
/// Run with integration tag:
/// ```bash
/// ANTHROPIC_API_KEY=your-key dart test -t integration
/// ```
///
/// Exclude from CI:
/// ```bash
...
/// ```
///
/// Note: This test requires network access and a valid Anthropic API key.
