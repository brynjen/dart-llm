/// Shared helpers, configuration, and test tools for Claude integration tests.
library;
...
String? getApiKey() => Platform.environment['ANTHROPIC_API_KEY'];
...
ClaudeChatRepository createRepository({
  String? customApiKey,
