...
void main() {
  group('VLLM Integration Tests - Concurrency', () {
    ...
    test('sustains 16 concurrent streams through one repository', () async {
    ...
    test('concurrent streams each report their own usage', () async {
    ...
    test('base URL is accepted with or without the /v1 suffix', () async {
