/// Shared helpers, configuration, and test tools for Gemini integration tests.
library;
...
GeminiChatRepository createRepository({
  String? customApiKey,
  ...
  return GeminiChatRepositoryBuilder()
      .apiKey(apiKey)
      .baseUrl(customBaseUrl ?? 'https://generativelanguage.googleapis.com')
      .timeoutConfig(
        timeoutConfig ??
            const TimeoutConfig(
