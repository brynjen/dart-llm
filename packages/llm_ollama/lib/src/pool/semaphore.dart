...
class Semaphore {
  ...
  /// Acquires a permit, throwing [OllamaQueueTimeoutException] if [timeout]
  ...
  Future<void> acquireWithTimeout(Duration timeout) async {
    ...
    try {
      ...
      throw OllamaQueueTimeoutException(
...
class OllamaQueueTimeoutException implements Exception {
  const OllamaQueueTimeoutException(this.message);
  final String message;
  @override
  String toString() => 'OllamaQueueTimeoutException: $message';
}
